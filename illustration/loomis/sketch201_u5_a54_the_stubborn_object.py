"""A54 — The Stubborn Object. Tests A53's claim against a CLOSED object: an unmistakable cup
(body + handle), identical in the same six relationships as A53. Does any relationship reclassify
it — or does something else absorb the conflict? Blind pass: captionless + shuffled."""
...
def cup(d,o):
    ello(d,(o[0]+170,o[1]+150),11,9,INK,w=2.6)                                   # handle
    d.polygon([(int((o[0]+133)*SS),int((o[1]+134)*SS)),(int((o[0]+167)*SS),int((o[1]+134)*SS)),
               (int((o[0]+162)*SS),int((o[1]+167)*SS)),(int((o[0]+138)*SS),int((o[1]+167)*SS))],fill=INK)
...
def p_water(d,o):
    ...
    cup(d,o)
def p_string(d,o):
    L(d,[(o[0]+150,o[1]+18),(o[0]+150,o[1]+134)],w=1.5); cup(d,o)
def p_plinth(d,o):
    cup(d,o)
...
def p_ground(d,o):
    L(d,[(o[0]+20,o[1]+167),(o[0]+280,o[1]+167)],col=MID,w=1.8); cup(d,o)
...
if __name__=="__main__":
    render("/sessions/wizardly-stoic-cerf/mnt/outputs/_cup_blind.png",blind=True)
